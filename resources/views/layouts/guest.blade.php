...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Foodia') }}</title>
    ...
    <body class="max-w-7xl mx-auto space-y-20 py-10 px-4 xl:px-0">
        ...
        <div class="flex justify-start sm:justify-between flex-col sm:flex-row">
            <div><p class="text-3xl font-bold">Foo<span class="text-green-800">di</span>e</p></div>
            <div>
                <ul class="flex flex-row space-x-4 justify-start sm:justify-center items-center">
                    <li><a href="/">Home</a></li>
                    <li><a href="#">About Us</a></li>
                    <li><a href="{{route('menus.index')}}">Menu</a></li>
                    <li><a href="{{route('reservations.step.one')}}">Make Reservation</a></li>
        ...
        <div class="text-gray-700">
            <div class="justify-start flex flex-col items-center py-8 mx-auto max-w-7xl sm:flex-row">
                ...
                <p class="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l sm:border-gray-200 sm:mt-0">© 2022 Foodie
                </p>
